...
router.post('/add/banner',  ADAuth , upload_Banner.single('myBanner'), addBanner)
...
// router.delete('/delete/banner/:id', ADAuth, deleteBanner)
router.delete('/deleteall', ADAuth, deleteallban)
