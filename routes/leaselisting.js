...
const {upload_Leaselisting}= require("../multer");
...
const { addLeaselisting, getbyid, getLeaselisting, subcategoryleaselisting, categoryleaselisting } = require("../controller/leaselistingcntrl");

  

router.post('/add', Auth, upload_Leaselisting.array('leaselisting_images', 10),addLeaselisting)
